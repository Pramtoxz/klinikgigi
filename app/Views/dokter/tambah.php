    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="<?= site_url('dokter') ?>" method="post" class="form">
                    <?= csrf_field() ?>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="id_dokter">ID Dokter</label>
                                <input type="text" class="form-control" id="id_dokter" name="id_dokter" value="<?= $next_id ?>" readonly>
                                <small class="text-muted">ID Dokter otomatis dibuat oleh sistem</small>
                            </div>
