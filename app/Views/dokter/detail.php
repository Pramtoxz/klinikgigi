        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    ...
                    <div>
                        <a href="<?= site_url('dokter/' . $dokter['id_dokter'] . '/edit') ?>" class="btn btn-warning me-1">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row mb-3">
                            <label class="col-md-4 col-form-label">ID Dokter</label>
                            <div class="col-md-8">
                                <p class="form-control-plaintext"><?= $dokter['id_dokter'] ?></p>
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-8">
                                <p class="form-control-plaintext"><?= $dokter['jenkel'] == 'L' ? 'Laki-laki' : 'Perempuan' ?></p>
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                            <label class="col-md-4 col-form-label">Tanggal Lahir</label>
                            <div class="col-md-8">
                                <p class="form-control-plaintext"><?= date('d F Y', strtotime($dokter['tgllahir'])) ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-8">
                                <p class="form-control-plaintext"><?= $dokter['nohp'] ?></p>
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-8">
                                <p class="form-control-plaintext"><?= date('d F Y H:i', strtotime($dokter['created_at'])) ?></p>
                            </div>
                        </div>
                    </div>
                </div>
