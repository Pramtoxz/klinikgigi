...
<div class="card shadow mb-4 animate__animated animate__fadeIn">
    ...
    <div class="card-body">
        <form id="formTambahTamu" method="post" action="<?= site_url('tamu/create') ?>">
            <?= csrf_field() ?>
            
            <div class="mb-3 row">
                <label for="nik" class="col-sm-3 col-form-label">NIK</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="nik" name="nik" value="<?= old('nik') ?>" required maxlength="16" placeholder="Masukkan NIK (16 digit)">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-9">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="jenkel" id="jenkel-l" value="L" <?= old('jenkel') == 'L' ? 'checked' : '' ?> required>
                        <label class="form-check-label" for="jenkel-l">Laki-laki</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="jenkel" id="jenkel-p" value="P" <?= old('jenkel') == 'P' ? 'checked' : '' ?> required>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control datepicker" id="tgllahir" name="tgllahir" value="<?= old('tgllahir') ?>" required placeholder="Pilih tanggal lahir" autocomplete="off">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="nohp" name="nohp" value="<?= old('nohp') ?>" required placeholder="Masukkan nomor HP">
